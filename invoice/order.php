        ...
        <table id="ordersTable" class="display">
            ...
            <?php while ($invoice = $invoices_query->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><button class="btn-action download">Generate</button><a href="<?= BASE_URL ?>invoice/generatepdf?shop_id=<?= $shop_id ?>&order_id=<?= $invoice['order_id'] ?>" class="view-invoice">View</a></td>
                    <td>
